    ...
    <div class="wrapper-page">
        <div class=" card-box" style="background-color:yellow">
            <div class="panel-heading">
                <h3 class="text-center"> Sign In to <strong class="text-custom">Library</strong> </h3>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <p style="color:black;"><strong>Don't have an account?</strong> <a href="page-register.html"
